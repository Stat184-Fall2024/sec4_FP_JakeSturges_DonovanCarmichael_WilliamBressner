---
title: "The Relationship Between Stadium Attendance and City Population In Relation to Winning Percentage of NFL Teams (2010-2019)"
...
![Figure 1](images/clipboard-1753446289.png){fig-align="center"}
...
![Figure 2](images/clipboard-2999790774.png){fig-align="center"}
...
![Figure 3](images/clipboard-532196286.png){fig-align="center"}
...
![Figure 4](images/clipboard-527994289.png){fig-align="center"}
...
![Figure 5](images/clipboard-1809128877.png){fig-align="center"}
...
![Figure 6](images/clipboard-446120001.png){fig-align="center"}
...
![Figure 7](images/clipboard-3644376010.png)

Based on Figure 7, there is team by team trends, however, there is a general line that is followed. There are some outliers, like the Patriots which have a much higher win percentage on average.

![Figure 8](images/clipboard-158954839.png){fig-align="center"}
...
![Figure 9](images/clipboard-2496314533.png){fig-align="center"}
...
![Figure 10](images/clipboard-2809135962.png){fig-align="center"}
...
![Table 1](images/clipboard-3300352420.png){fig-align="center"}
...
![Figure 11](images/clipboard-1754671410.png){fig-align="center"}
...
![Table 2](images/clipboard-402414960.png){fig-align="center"}
...
ggplot( 
  ...
  aes(x=as.factor(Team), # x-axis is based on teams
      ...
      fill = Team)) + # Fill based on which team
  geom_boxplot( 
    alpha=0.7) + 
