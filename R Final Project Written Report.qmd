...
Above is our regression summary statistics for the population vs win percentage data. With a p-value of 0.0543222 greater than our required alpha level of 0.05, we cannot say that the slope of the regression line differs from 0 and it is not a significant predictor of win percentage. Since we fail to reject our null hypothesis, we cannot however say that the slope of city population vs win percentage is 0, only that we can't say it is different from 0 with certainty.
